...
int32_t tim = 0;
EffeHandle* h1 = nullptr;
void StateParticleTest1::InitState() {
	...
	fxMan = new EffeManager();
	fx1 = fxMan->LoadFX(u"game/fx/Laser01.efk");
	h1 = fxMan->Play(fx1,glm::vec3(0,0,0));
	fxMan->SetCam(world->GetCam());
//	while (true) {}
...
void StateParticleTest1::UpdateState() {
...
void StateParticleTest1::SetMouse(float x, float y, float z) {
...
void StateParticleTest1::SetKey(int key, bool state) {
...
void StateParticleTest1::RenderState() {
	//ui->Render();
