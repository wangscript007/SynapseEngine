...
void StateFPSTest1::UpdateState() {
...
void StateFPSTest1::SetMouse(float x, float y, float z) {
...
void StateFPSTest1::SetKey(int key, bool state) {
...
void StateFPSTest1::RenderState() {
	//ui->Render();
	world->UpdatePhysics();
	p1->Update();
	world->RenderShadows();
